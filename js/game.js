class Game{
   ...
   DownArrow.position(150,height/2+400)
    ...
    WinButton.mouseClicked(()=>{
      ...
      StageButton3.style("border-color","white");
        ...
        StageButton3.mouseClicked(()=>{
          ...
          Enemy_img.visible = true;
          Enemy_img.addAnimation("Idle",IdleRobot)
          Enemy_img.changeAnimation("Idle",IdleRobot);
          Enemy_img.scale = 0.4
        //  Stage1Screen.visible = false
          CancelButton.show();
          CancelButton.mousePressed(()=>{
...
stage3(){
  background(Stage4Screen_Img)
  gameState = "Stage3"
var  Stage3Screen = createSprite(width/2,height/2,10,10);
  Stage3Screen.addAnimation("Screen3",Stage3Screen_Img)
  //Stage3Screen_Img.show()
//Stage3Screen_Img.position(width/2,height/2,10,10)
  Stage3Screen.scale = 2
  //Sta//ge3Screen_Img.depth = -1
  attackButton1 = createButton("1");
  attackButton1.position(width/2,height/2);
//  attackButton1.style("background-image","url(https://www.fixpicture.org/medias/1625104432_tmp_RollSword_4_.png)");
  attackButton1.style("background-size","120%");
...
winS3(){
 ...
 WinButton2.hide();
 WinScreen.visible= false;
 Star1.visibility = false;
 Star2.visibility = false;
    ...
    StageButton2.style("border-radius","80px");
    StageButton2.style("border-color","white");
    StageButton3.style("background-image","url(Sprites/Images/Buttons/PassedButton.png)");
    StageButton3.style("background-size","120%");
    StageButton3.style("border-radius","80px");
    StageButton3.style("border-color","white");
...
stage4(){
  gameState = "Stage4"
   map.destroy()
  var  Stage4Screen = createSprite(width/2,height/2,10,10);
    Stage4Screen.addImage(Stage4Screen_Img)
    Stage4Screen.scale = 1.8
    attackButton1 = createButton("1");
    attackButton1.position(width/2,height/2);
  //  attackButton1.style("background-image","url(https://www.fixpicture.org/medias/1625104432_tmp_RollSword_4_.png)");
    attackButton1.style("background-size","120%");
    ...
    attackButton1.size(50,50)
    attackButton1.hide();
    NinjaRobot = new Ninja(displayWidth/2+300,displayHeight-170);
  BlueFire = new Player(250,displayHeight-170)
...
winS4(){
 ...
 Star2.visibility = false;
    ...
    StageButton3.style("border-radius","80px");
    StageButton3.style("border-color","white");
    StageButton4.style("background-image","url(Sprites/Images/Buttons/PassedButton.png)");
    StageButton4.style("background-size","120%");
    StageButton4.style("border-radius","80px");
    StageButton4.style("border-color","white");
    StageButton5.style("background-image","url(Sprites/Images/Buttons/UnlockedButton.png)");
    StageButton5.style("background-size","120%");
    StageButton5.style("border-radius","80px");
    StageButton5.style("border-color","white");
      ...
      StageButton4.mouseClicked(()=>{
        StageButton1.hide();
        StageButton2.hide();
        StageButton5.style("background","pink")
        StageButton5.size(80,50)
        StageButton5.style("background-image","url(Sprites/Images/Buttons/Stage3_Button (1).png)");
        StageButton5.style("background-size","200%");
        StageButton5.style("border-radius","50px");
        StageButton5.style("border-color","yellow");
        StageButton5.style("background-repeat","no-repeat");
        StageButton5.style("background-position","center");
        StageButton3.hide();
        StageButton4.hide();
        StageScreen.visible = true
        StageScreen.visibility = 100
        StageButton5.position(displayWidth/2,displayHeight-200);
        StageScreen.addImage(StageScreen_Img);
...
stage5(){
  gameState = "Stage5"
  map.destroy()
  var  Stage5Screen = createSprite(width/2,height/2,10,10);
    Stage5Screen.addImage(Stage5Screen_img)
    Stage5Screen.scale = 2.2
    attackButton1 = createButton("1");
    attackButton1.position(width/2,height/2);
  //  attackButton1.style("background-image","url(https://www.fixpicture.org/medias/1625104432_tmp_RollSword_4_.png)");
    attackButton1.style("background-size","120%");
    ...
    attackButton1.size(50,50)
    attackButton1.hide();
    BloodMan1 = new bloodMan(displayWidth/2+300,displayHeight-170);
  BlueFire = new Player(250,displayHeight-170)
